    ...
    <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-lg border shadow-sm p-6">
              <div className="flex items-center gap-3 mb-3">
                <div className="h-10 w-10 rounded-lg bg-[#0C2E4C] flex items-center justify-center flex-shrink-0">
            ...
            <div className="bg-white rounded-lg border shadow-sm p-6">
              <div className="flex items-center gap-3 mb-3">
                <div className="h-10 w-10 rounded-lg bg-[#1C7393] flex items-center justify-center flex-shrink-0">
                  <Eye className="h-5 w-5 text-white" />
                </div>
                <h3 className="font-semibold">2. Entity Extraction</h3>
              </div>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="bg-white rounded-lg border shadow-sm p-6">
              <div className="flex items-center gap-3 mb-3">
                <div className="h-10 w-10 rounded-lg bg-[#1F9CB4] flex items-center justify-center flex-shrink-0">
                  <Shield className="h-5 w-5 text-white" />
                </div>
                <h3 className="font-semibold">3. Deterministic Matching</h3>
              </div>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="bg-white rounded-lg border shadow-sm p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-semibold">4. Transparent Results</h3>
              </div>
              <p className="text-sm text-muted-foreground">
      ...
      <section className="py-16">
        <div className="container max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground leading-relaxed mb-2 max-w-2xl mx-auto">
